!function (t, e) {
        ...
        function o(r) {
            ...
            return o && t.each(o.split(" "), function (r) {
                ...
                t.each(this.split(","), function (r, i) {
                    if ("title" == i)a.append("<span class='fc-header-title'><h2>&nbsp;</h2></span>"), o && o.addClass(d + "-corner-right"), o = null; else {
                        var s;
                        if (e[i] ? s = e[i] : me[i] && (s = function () {
                                u.removeClass(d + "-state-hover"), e.changeView(i)
                            }), s) {
                            var l = n.theme ? Y(n.buttonIcons, i) : null, c = Y(n.buttonText, i), u = t("<span class='fc-button fc-button-" + i + " " + d + "-state-default'>" + (l ? "<span class='fc-icon-wrap'><span class='ui-icon ui-icon-" + l + "'/></span>" : c) + "</span>").click(function () {
    ...
    function o(n, r) {
        ...
        function s(e, r) {
            ...
            if (l)t.isFunction(l) ? (m(), l(d(T), d(E), function (t) {
                ...
                var c = e.url;
                if (c) {
                    var u, f = e.success, v = e.error, h = e.complete;
                    u = t.isFunction(e.data) ? e.data() : e.data;
                    var g = t.extend({}, u || {}), p = X(e.startParam, n.startParam), b = X(e.endParam, n.endParam);
        ...
        for (var T, E, S = M.trigger, x = M.getView, k = M.reportEvents, H = {events: []}, F = [H], R = 0, N = 0, z = 0, W = [], A = 0; A < r.length; A++)c(r[A])
    }
    ...
    function D(t, e, n, r) {
        ...
        for (a = 0; u > a; a++)if (o = n.charAt(a), "'" == o) {
            ...
            for (i = u; i > a; i--)if (s = Te[n.substring(a, i)]) {
                l && (f += s(l, r)), a = i - 1;
                break
            }
            i == a && l && (f += o)
    ...
    function X() {
        for (var t = 0; t < arguments.length; t++)if (arguments[t] !== e)return arguments[t]
    }
    ...
    function Z(e, n, r) {
        ...
        function h(t) {
            var e = he + "-widget-content", n = O.start.getMonth(), r = f(new Date), a = "", o = ["fc-day", "fc-" + De[t.getDay()], e];
        ...
        var L, _, Y, j, I, X, J, V, U, Z, $, Q, K, te, ee, ne, re, oe, ie, se, de, he, ge, pe, me, ye, be = O.opt, we = O.trigger, Ce = O.renderOverlay, Me = O.clearOverlays, Te = O.daySelectionMousedown, Ee = O.cellToDate, Se = O.dateToCell, xe = O.rangeToSegments, ke = n.formatDate;
    ...
    function K(n, r, a) {
        ...
        function s() {
            var e, r, a, o, i, s = Be + "-widget-header", l = Be + "-widget-content", f = Ze("slotMinutes") % 15 == 0;
        ...
        function T(t) {
            if (!Ze("selectable")) {
                var e = Math.min(Ae - 1, Math.floor((t.pageX - K.offset().left - ke) / He)), n = rn(0, e), r = this.parentNode.className.match(/fc-slot(\d+)/);
                if (r) {
    ...
    function te() {
        ...
        function a(e) {
            ...
            for (r = 0; v > r; r++)for (n = Y(0, r), u(n, h), a = ee(o(e, p, n, u(d(n), g - h))), ne(a), s = 0; s < a.length; s++)for (l = a[s], c = 0; c < l.length; c++)f = l[c], f.col = r, f.level = s, m.push(f);
            return m
        }
        ...
        function s(n, r) {
            var a, o, i, s, l, u, d, v, h, g, p, m, D, w, C, M, E, S, k, H = n.length, N = "", z = F();
        ...
        function g(t, e, n) {
            ...
            var o, i, s, c, f, v, g, p, D, w, M, T = m.getCoordinateGrid(), E = P(), S = I(), x = X(), k = J();
            e.draggable({
                scroll: !1,
                grid: [S, x],
                axis: 1 == E ? "y" : !1,
    ...
    function ee(t) {
        ...
        for (e = 0; s > e; e++) {
            for (n = t[e], r = 0; ;) {
                if (a = !1, i[r])for (o = 0; o < i[r].length; o++)if (re(i[r][o], n)) {
                    a = !0;
                    break
                }
                if (!a)break;
    ...
    function ne(t) {
        var e, n, r, a, o, i;
        for (e = t.length - 1; e > 0; e--)for (a = t[e], n = 0; n < a.length; n++)for (o = a[n], r = 0; r < t[e - 1].length; r++)i = t[e - 1][r], re(o, i) && (i.forward = Math.max(i.forward || 0, (o.forward || 0) + 1))
    }
    ...
    function ae(n, r, a) {
        ...
        function O(t) {
            var e = B.getColCnt(), n = ee ? -1 : 1, r = ee ? e - 1 : 0, a = Math.floor(t / e), o = (t % e + e) % e * n + r;
            return {row: a, col: o}
        }
    ...
    function oe() {
        ...
        function M(e, r, a) {
            ...
            B(r), r.mousedown(function (t) {
                ...
                if (1 == o.which) {
                    c = !0;
                    var u, f, d = te(), v = (Y(), P(), r.css("top")), h = t.extend({}, e), g = ce(le(e.start));
    ...
    function ue(t) {
        ...
        r.build = function () {
            ...
            for (a = 0; o > a; a++)if (r >= e[a][0] && r < e[a][1]) {
                s = a;
                break
            }
            for (a = 0; i > a; a++)if (t >= n[a][0] && t < n[a][1]) {
                l = a;
                break
            }
    ...
    var De = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"], we = 864e5, Ce = 36e5, Me = 6e4, Te = {
        s: function (t) {
            return t.getSeconds()
        }, ss: function (t) {
    ...
    pe.dateFormatters = Te, pe.applyAll = I, me.month = J, me.basicWeek = V, me.basicDay = U, n({weekMode: "fixed"}), me.agendaWeek = $, me.agendaDay = Q, n({
        allDaySlot: !0,
        allDayText: "all-day",
        firstHour: 6,
        slotMinutes: 30,
