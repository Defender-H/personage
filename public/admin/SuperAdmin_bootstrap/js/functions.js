$(document).ready(function(){
    ...
    var settings =  '<a id="settings" href="#changeSkin" data-toggle="modal">' +
			...
			'<div class="modal-dialog modal-lg">' +
				...
				'<div class="modal-header">' +
				    ...
				    '<h4 class="modal-title">修改皮肤颜色</h4>' +
				'</div>' +
				'<div class="modal-body">' +
				    '<div class="row template-skins">' +
					'<a data-skin="skin-blur-1" class="col-sm-2 col-xs-4" href="">' +
						'<img src="/admin/SuperAdmin_bootstrap/img/body/1.jpeg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-2" class="col-sm-2 col-xs-4" href="">' +
					'<img src="/admin/SuperAdmin_bootstrap/img/body/2.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-3" class="col-sm-2 col-xs-4" href="">' +
					'<img src="/admin/SuperAdmin_bootstrap/img/body/3.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-4" class="col-sm-2 col-xs-4" href="">' +
					'<img src="/admin/SuperAdmin_bootstrap/img/body/4.jpg" alt="">' +
					'</a>' +


					'<a data-skin="skin-blur-violate" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="/admin/SuperAdmin_bootstrap/img/skin-violate.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-lights" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="/admin/SuperAdmin_bootstrap/img/skin-lights.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-city" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="/admin/SuperAdmin_bootstrap/img/skin-city.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-greenish" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="/admin/SuperAdmin_bootstrap/img/skin-greenish.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-night" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="/admin/SuperAdmin_bootstrap/img/skin-night.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-blue" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="/admin/SuperAdmin_bootstrap/img/skin-blue.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-sunny" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="/admin/SuperAdmin_bootstrap/img/skin-sunny.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-cloth" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="/admin/SuperAdmin_bootstrap/img/skin-cloth.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-tectile" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="/admin/SuperAdmin_bootstrap/img/skin-tectile.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-chrome" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="/admin/SuperAdmin_bootstrap/img/skin-chrome.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-ocean" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="/admin/SuperAdmin_bootstrap/img/skin-ocean.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-sunset" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="/admin/SuperAdmin_bootstrap/img/skin-sunset.jpg" alt="">' +
					'</a>' +
					'<a data-skin="skin-blur-yellow" class="col-sm-2 col-xs-4" href="">' +
					    '<img src="/admin/SuperAdmin_bootstrap/img/skin-yellow.jpg" alt="">' +
					'</a>' +
					'<a  data-skin="skin-blur-kiwi"class="col-sm-2 col-xs-4" href="">' +
					    '<img src="/admin/SuperAdmin_bootstrap/img/skin-kiwi.jpg" alt="">' +
					'</a>' +
				    '</div>' +
				'</div>' +
			    '</div>' +
	...
	//判断是否有选择背景
	console.log(getCookies('skin'));
	if(getCookies('skin')==null){
		alert('现在为默认颜色，可以更换自己喜欢的皮肤哦！');
	}else{
		$('body').attr('id', getCookies('skin'));
	}
    ...
    $('body').on('click', '.template-skins > a', function(e){
		...
		//存储背景颜色名
		setcookie('skin',skin,5);
    });

	function getCookies(cookie_name){
		var value = document.cookie.match(new RegExp("(^| )" + cookie_name + "=([^;]*)(;|$)"));
